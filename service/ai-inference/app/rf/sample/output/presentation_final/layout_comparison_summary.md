...
후보 기반 2AP 배치에서 평균 RSSI가 단일 AP 대비 약 8.33 dB 개선되었다. 최저 RSSI는 약 10.02 dB 개선되어 약한 구간이 완화되었다. 단일 AP에서는 일부 격자가 데드존이었으나, 2AP 배치에서는 데드존이 사라졌다. 평균 벽 손실은 다중 AP·서빙 구역 분담으로 상대적으로 완화된 것으로 나타난다. top-1 대비 top-2는 평균 RSSI 차이 5.53 dB.
