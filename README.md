...
- `packages/rf_core`
  - RF scene 변환, baseline preview 계산, Sionna 관련 어댑터를 포함하는 RF 계산 코어입니다.
- `docs`
...
- packages/ai_runtime
    - U-Net / YOLO 로딩 및 추론 런타임
- packages/rf_core
    - RF 변환 / 계산 / material mapping / simulation / persistence
- docs
    - 개발 규약 및 참고 문서
...
RF preview 계산을 위한 공용 코어입니다.

포함 범위:

- backend scene → RF scene 변환
- baseline preview 계산
- material mapping
- simulation
- persistence
- Sionna 관련 adapter / engine plan 생성
