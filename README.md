...
- [공용 런타임 (AI/RF)](./packages/ai_runtime)
...
- `packages/ai_runtime`
  - 운영 API에서 재사용하는 AI/RF 런타임 모듈입니다.
  - U-Net inference
  - YOLO inference
  - Sionna RT adapter/runtime
- `docs`
...
│  └─ ai_runtime/          # U-Net / YOLO / Sionna RT 런타임
├─ docs/                   # 규약/설계 문서
└─ README.md
```
...
운영 API에서 재사용하는 AI/RF 런타임입니다.

- U-Net 모델 로딩 / probability inference
- YOLO 모델 로딩 / inference 결과 생성
- Sionna RT adapter / runtime
